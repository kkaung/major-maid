...
export async function generateMetadata({
    ...
    return {
        ...
        description: `Book your deep cleaning service with our trusted cleaners in 60 seconds. The ${suburb}'s best domestic cleaners and home cleaning service.`,
    };
}
    ...
    return (
        <Content
            ...
            segments={[
                ...
                {
                    title: suburb,
                    href: `/deep-cleaning-canberra/${params.location}`,
                },
            ]}
        />
    );
